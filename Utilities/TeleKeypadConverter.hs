...
toTeleKeypad = do 
    ...
    if input == "" then
      ...
      writeFile "teleKeypadOutput.txt" $ id $ toDigits $ removeExtraSpaces input
      blank
      toTeleKeypad 
...
fromTeleKeypad = do 
    ...
    if input == "" then
      ...
      writeFile "teleKeypadOutput.txt" $ id $ fromDigits $ removeExtraSpaces input
      blank
      fromTeleKeypad 

-- remove extra spaces from string (so no two consecutive spaces exist)
...
-- convert a string of telephone keypad digits to English
